...
public interface IVirtualDiskSpace {
	...
	/**
	 * Changes the size of the disk space. If the new size is smaller than the current size,
	 * the additional space is marked as free. If the newSize is bigger, additional DataBlocks
	 * are allocated and added to the disk space.
	 * 
	 * @param newSize the new size of the disk space
	...
	/**
	 * Returns the offset position, measured in bytes from the beginning of the disk space.
	 * 
