...
public interface IVirtualDisk extends AutoCloseable, Closeable {
    ...
    /**
     * This number is used to identify that file opened is actually a virtual file disk.
     */
    ...
    /**
     * Invalidates the {@link IDataBlock} given by block and marks the space previously occupied by
     * the {@link IDataBlock} as free.
     * 
    ...
    /**
     * Allocates {@link IDataBlock} to store the number of bytes given by size. The blocks
     * are returned as an array and internally linked with a linked list. Which means 
     * the first block has set next to the second block and so on.
     * 
     * @param size the number of bytes the data blocks have to be able to store 
    ...
    /**
     * Write the specified byte to the underlying file at the offset given by pos.
     * 
    ...
    /**
     * Write the specified byte array to the underlying file at the offset given by pos.
     * 
     * @param pos the offset position
     * @param b the data
     * @throws IOException if an I/O error occurs
    ...
    /**
     * Writes length bytes from the specified byte array starting at offset off to the underlying file
     * at the offset given by pos.
     * 
     * @param pos the offset position
     * @param b the data
    ...
    /**
     * Reads a signed eight-bit value from the underlying file at offset given by pos.
     * 
    ...
    /**
     * Reads up to b.length bytes of data from the underlying file into an array of bytes 
    ...
    /**
     * Reads up to length bytes of data from the underlying file starting at the offset given by pos 
     ...
     * 
     * @param parent the parent of the newly created directory
     * @param name the name of the newly created directory
     * @return the created directory
     * @throws IOException if the directory name was invalid or an I/O error occurred 
     */
     ...
     * 
     * @param parent the parent of the newly created file
     * @param name the name of the newly created file
     * @return the created file
     * @throws IOException if the file name was invalid or an I/O error occurred 
     */
