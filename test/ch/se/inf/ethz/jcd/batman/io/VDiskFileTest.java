...
public class VDiskFileTest {
    ...
    public void createDeleteTest() throws IOException {
    	...
    	assertEquals(disk.getRootDirectory(), testFile.getDiskEntry().getParent());
    	assertEquals(disk.getRootDirectory(), testFile.getParentFile().getDiskEntry());
    ...
    public void listTest() throws IOException {
        ...
        assertTrue(Arrays.asList(testDirectory.listFiles()).contains(new VDiskFile("/foo/bar", disk)));
        assertTrue(Arrays.asList(testDirectory.listFiles()).contains(new VDiskFile("/foo/foo", disk)));
    }
